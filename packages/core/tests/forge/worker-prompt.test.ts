...
import { buildWorkerPrompt } from '../../src/forge/worker/prompt.js'
...
describe('buildWorkerPrompt', () => {
  it('includes the complete brief and required JSON result instructions', () => {
    const brief: TaskBrief = {
      ...
      dependsOn: ['phase-b'],
      fileScope: ['packages/core/src/forge/worker/**'],
    ...
    expect(prompt).toContain('packages/core/src/forge/worker/**')
