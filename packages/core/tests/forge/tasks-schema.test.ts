/**
 * @fileoverview Tests for Forge planned-task DAG validation.
 */

import { describe, expect, it } from 'vitest'
import { ForgeValidationError } from '../../src/forge/errors.js'
import { parseTasksPlan } from '../../src/forge/tasks-schema.js'
...
describe('parseTasksPlan', () => {
  ...
  it('rejects an empty task list', () => {
    expect(() => parseTasksPlan({ tasks: [] })).toThrow(ForgeValidationError)
  })
