...
import { ClaudeConflictResolver } from '../../src/forge/claude/conflict-resolver.js'
import type { MergeConflict } from '../../src/forge/merge/conflict.js'
...
beforeEach(async () => {
  testRoot = await mkdtemp(join(tmpdir(), 'forge-claude-resolver-'))
