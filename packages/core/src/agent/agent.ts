/**
 * @fileoverview High-level Agent class for codefleet.
 *
 ...
 * @example
 * ```ts
 * import { Agent, ToolRegistry, ToolExecutor, registerBuiltInTools } from '@codefleet/core'
 *
 ...
 * // `new CodeFleet().runAgent(config, prompt)` instead.
 * ```
 */
