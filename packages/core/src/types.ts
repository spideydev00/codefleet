/**
 * @fileoverview Core type definitions for the codefleet orchestration framework.
 *
...
export interface TeamConfig {
   ...
   *
   * SDK-only: the CLI (`codefleet`) cannot pass runtime objects through its JSON config.
   */
...
/** Input task descriptor accepted by {@link CodeFleet.runTasks}. */
...
/** Per-call options for {@link CodeFleet.runTasks}. */
...
/**
 * Per-call options for {@link CodeFleet.runTeam}. Differs from
 ...
 * {@link CodeFleet.runConsensus} and the per-task `verify` hook. The
...
/** Options for {@link CodeFleet.runConsensus}. */
...
/** Options accepted by {@link CodeFleet.restore}. */
